...
__IO uint16_t ADC_ConvertedValue[40];//将转换值存在ADC_ConvertedValue变量
...
//DMA_InitStructure.DMA_PeripheralBaseAddr = ADC1_DR_Address;	 			//ADC地址
  DMA_InitStructure.DMA_PeripheralBaseAddr=(u32)&ADC1->DR;
	DMA_InitStructure.DMA_MemoryBaseAddr = (u32)&ADC_ConvertedValue;	//如果是单通道貌似要把地址符号去掉
