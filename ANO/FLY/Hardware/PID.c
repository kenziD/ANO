...
extern u8 GyroPidArmed;
extern u8 AnglePidArmed;
//void PID_Analyze(void)
//{
//	if(adjustGyroPid&&!GyroPidArmed)
//	{
//		//1000~2000
...
//	}
//	else if((!adjustGyroPid)&&!AnglePidArmed)
//	{
//		PID_ROLL.KP = (Rc_Data.aux1-1000)/200.0f;//0-5
//    PID_ROLL.KI = (Rc_Data.aux2-1000)/2000.0f;//0-0.5
//    PID_ROLL.KD = (Rc_Data.aux3-1000)/66.6f;//0-15
//		
//		PID_PITCH.KP = (Rc_Data.aux1-1000)/200.0f;//0-5
//    PID_PITCH.KI = (Rc_Data.aux2-1000)/2000.0f;//0-0.5
//    PID_PITCH.KD = (Rc_Data.aux3-1000)/66.6f;//0-15
//	}
//}
void PID_Analyze(void)
{
...
void angleControl(floatEurlaAngle *outAngle, floatEurlaAngle *desireAngle, int16_t expThro)
{
    ...
    lastAngle.pitch = controlAngle.pitch;
		 ...
		 //////////////////////////////////yaw/////////////////////////////////////
//    controlAngle.yaw = desireAngle->yaw - outAngle->yaw;

//    PID_YAW.intergral += controlAngle.yaw;

//    if (PID_YAW.intergral > PID_YAW.Imax) PID_YAW.intergral = PID_YAW.Imax;
//    if (PID_YAW.intergral < -PID_YAW.Imax) PID_YAW.intergral = -PID_YAW.Imax;
//    if (expThro < 200)
//    {
//        PID_YAW.intergral  = 0;
//    }
//    PID_YAW.output =  PID_YAW.KP * controlAngle.yaw + PID_YAW.KI * PID_YAW.intergral - PID_YAW.KD * fGYRO_Z;
//    lastAngle.yaw = controlAngle.yaw;
}
